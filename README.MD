...
See thinput_tester if you want to see the input mapper in action.

```c
gcc thinput_tester -o tinput
```
...
change these statements to make the library.
...
And change it to a function that loads a file into the instructions array
