...
static THINPUT_S thinput_handle(THINPUT_S* in, THINPUT_S* out, THINPUT_S* code){
	    ...
	    #define DISPATCH() THINPUT_GET_BYTE(ins); switch(ins){\
	    	...
	    	case THINPUT_OP_COPY: goto do_THINPUT_OP_COPY;\
	    	case THINPUT_OP_COPY_BACK: goto do_THINPUT_OP_COPY_BACK;\
	    	case THINPUT_OP_WRITE: goto do_THINPUT_OP_WRITE;\
	    	case THINPUT_OP_WRITE_BACK: goto do_THINPUT_OP_WRITE_BACK;\
	    	case THINPUT_OP_MULT_CONSTANT: goto do_THINPUT_OP_MULT_CONSTANT;\
	    	case THINPUT_OP_ADD_CONSTANT: goto do_THINPUT_OP_ADD_CONSTANT;\
	    	case THINPUT_OP_MULT: goto do_THINPUT_OP_MULT;\
	    	case THINPUT_OP_ADD: goto do_THINPUT_OP_ADD;\
	    	case THINPUT_OP_SUB_CONSTANT: goto do_THINPUT_OP_SUB_CONSTANT;\
	    	case THINPUT_OP_SUB: goto do_THINPUT_OP_SUB;\
	    	case THINPUT_OP_SKIP_GREATER_CONSTANT: goto do_THINPUT_OP_SKIP_GREATER_CONSTANT;\
	    	case THINPUT_OP_SKIP_GREATER: goto do_THINPUT_OP_SKIP_GREATER;\
	    	case THINPUT_OP_COPY_ALL: goto do_THINPUT_OP_COPY_ALL;\
	    }
